...
- **UI Language:** Controls the text strings in the interface (English, Spanish, French, Portuguese, Persian, Turkish, Filipino, German, Italian, Japanese, Simplified Chinese, Taiwan Traditional Chinese, Korean, Bahasa Indonesia, Dutch, Hindi, and Bengali/Bangla) and date/time presentation language (via `useFormatDate` / `useLocale`), allowing operators in any country to view dates in their preferred language.
...
Translating FloCafe into Italian, Japanese, Simplified Chinese, Taiwan Traditional Chinese, Korean, German, Dutch, Hindi, or Bengali/Bangla does not require creating a tax pack, and adding a tax pack for a new country does not require adding a new UI language.
