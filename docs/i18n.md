...
- **UI Language:** Controls the text strings in the interface (English, Spanish, French, Portuguese, Persian, Turkish, Filipino, German, Italian, Japanese, Simplified Chinese, Korean, Bahasa Indonesia, and Dutch) and date/time presentation language (via `useFormatDate` / `useLocale`), allowing operators in any country to view dates in their preferred language.
...
Translating FloCafe into Italian, Japanese, Simplified Chinese, Korean, German, or Dutch does not require creating a tax pack, and adding a tax pack for a new country does not require adding a new UI language.
