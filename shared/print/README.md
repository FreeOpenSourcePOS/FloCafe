...
| `document.ts` | Renderer-independent `PrintDocument` v1 / `KotDocument` v1 (#442/#443): receipt and kitchen-ticket block types, `PrintData`/`PrintContext` snapshots, and pure `buildBillDocument` / `buildKotDocument`. Currency display context and schema policy are documented in [docs/printing-architecture.md](../../docs/printing-architecture.md) (#449) |
