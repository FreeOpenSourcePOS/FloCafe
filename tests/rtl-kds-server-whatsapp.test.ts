...
async function run(): Promise<void> {
  ...
  for (const lang of ['en', 'es', 'fr', 'pt', 'fa', 'it', 'ja', 'zh', 'ko', 'id', 'nl'] as const) {
  ...
  for (const ltrLang of ['en', 'es', 'fr', 'pt', 'it', 'ja', 'zh', 'ko', 'id', 'nl'] as const) {
  ...
  const getTestTranslator = (lang: 'en' | 'es' | 'fr' | 'pt' | 'fa' | 'it' | 'ja' | 'zh' | 'ko' | 'id' | 'nl') => {
