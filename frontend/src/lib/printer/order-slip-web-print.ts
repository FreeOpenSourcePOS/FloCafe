...
export function generateOrderSlipHtml(order: Order, labels: OrderSlipLabels, opts: OrderSlipWebPrintOptions = {}): string {
  ...
  return `
    <div class="order-slip" lang="${escapeHtml(locale)}" dir="${direction}" style="width:100%;max-width:${paperWidthCss};min-width:0;box-sizing:border-box;overflow-wrap:anywhere;word-break:break-word;padding:${padding};font-family:'Courier New',monospace;font-size:${fontSize};direction:${direction};text-align:${textAlign};">
