...
const PRINT_LABELS: Record<PrintLabelLanguage, PrintLabelTable> = {
  ...
  de: {
    'print.taxInvoiceTitle': "[DE] TAX INVOICE",
    'print.invoiceTitle': "[DE] INVOICE",
    'print.invoiceNumber': "[DE] Invoice #:",
    'print.time': "[DE] Time",
    'print.customerShort': "[DE] Customer",
    'print.numberShort': "[DE] Customer No",
    'print.address': "[DE] Address",
    'print.call': "[DE] Call",
    'print.note': "[DE] Note",
    'print.phoneLong': "[DE] Phone",
    'print.subtotalExclTax': "[DE] Subtotal (excl. tax)",
    'print.serviceChargeShort': "[DE] Service Chg",
    'print.grandTotal': "[DE] TOTAL",
    'print.thankYouShort': "[DE] Thank you!",
    'print.thankYouVisitAgain': "[DE] Thank you for your visit!",
    'print.pleaseComeAgain': "[DE] Please come again!",
    'print.ratesInclusiveNote': "[DE] Rates are inclusive of taxes",
    'print.pointsEarned': "[DE] Points Earned",
    'print.pointsBalance': "[DE] Points Balance",
    'print.pointsRedeemed': "[DE] Points Redeemed",
    'print.kot.title': "[DE] Kitchen Order Ticket",
    'print.kot.banner': "[DE] KITCHEN ORDER TICKET",
    'print.kot.station': "[DE] Station",
    'print.kot.type': "[DE] Type",
    'print.kot.noPendingItems': "[DE] No pending items",
    'print.kot.end': "[DE] END",
    'print.hsn': "[DE] HSN",
    'print.test.title': "[DE] Flo Printer Test",
    'print.test.networkUsb': "[DE] Network / USB test print",
    'print.test.columns': "[DE] Columns",
    'print.test.wrapHint': "[DE] If the next line wraps, choose a smaller column value.",
    'print.test.success': "[DE] If you can read this, your printer is working!",
    'receipt.billNumber': "[DE] Bill #",
    'receipt.date': "[DE] Date",
    'pos.tableLabel': "[DE] Table: {name}",
    'pos.customer': "[DE] Customer",
    'receipt.customerNo': "[DE] Customer No",
    'receipt.phone': "[DE] Ph",
    'receipt.item': "[DE] Item",
    'receipt.qty': "[DE] Qty",
    'receipt.rate': "[DE] Rate",
    'receipt.amount': "[DE] Amount",
    'printTest.amt': "[DE] Amt",
    'pos.subtotal': "[DE] Subtotal",
    'pos.discount': "[DE] Discount",
    'pos.tax': "[DE] Tax",
    'pos.delivery': "[DE] Delivery",
    'receipt.totalTax': "[DE] Total Tax",
    'receipt.serviceCharge': "[DE] Service Charge",
    'receipt.taxDetails': "[DE] Tax Details",
    'receipt.payments': "[DE] Payments",
    'receipt.thankYou': "[DE] Thank you for your visit!",
    'receipt.taxIncluded': "[DE] Tax included where applicable",
    'receipt.reprint': "[DE] REPRINT",
    'pos.methodCash': "[DE] Cash",
    'pos.methodCard': "[DE] Card",
    'pos.methodWallet': "[DE] Wallet",
  },
};
