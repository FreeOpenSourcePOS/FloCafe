...
// Rotation is electron-log's default: main.log caps at ~1MB, archived to
// main.log.old on rotation, so on-disk log usage stays bounded (~2MB total)
// without any explicit config here.
