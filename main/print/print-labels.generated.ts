...
const PRINT_LABELS: Record<PrintLabelLanguage, PrintLabelTable> = {
  ...
  fil: {
    'print.taxInvoiceTitle': "[FIL] TAX INVOICE",
    'print.invoiceTitle': "[FIL] INVOICE",
    'print.invoiceNumber': "[FIL] Invoice #:",
    'print.time': "[FIL] Time",
    'print.customerShort': "[FIL] Customer",
    'print.numberShort': "[FIL] Customer No",
    'print.address': "[FIL] Address",
    'print.call': "[FIL] Call",
    'print.note': "[FIL] Note",
    'print.phoneLong': "[FIL] Phone",
    'print.subtotalExclTax': "[FIL] Subtotal (excl. tax)",
    'print.serviceChargeShort': "[FIL] Service Chg",
    'print.grandTotal': "[FIL] TOTAL",
    'print.thankYouShort': "[FIL] Thank you!",
    'print.thankYouVisitAgain': "[FIL] Thank you for your visit!",
    'print.pleaseComeAgain': "[FIL] Please come again!",
    'print.ratesInclusiveNote': "[FIL] Rates are inclusive of taxes",
    'print.pointsEarned': "[FIL] Points Earned",
    'print.pointsBalance': "[FIL] Points Balance",
    'print.pointsRedeemed': "[FIL] Points Redeemed",
    'print.kot.title': "[FIL] Kitchen Order Ticket",
    'print.kot.banner': "[FIL] KITCHEN ORDER TICKET",
    'print.kot.station': "[FIL] Station",
    'print.kot.type': "[FIL] Type",
    'print.kot.noPendingItems': "[FIL] No pending items",
    'print.kot.end': "[FIL] END",
    'print.hsn': "[FIL] HSN",
    'print.test.title': "[FIL] Flo Printer Test",
    'print.test.networkUsb': "[FIL] Network / USB test print",
    'print.test.columns': "[FIL] Columns",
    'print.test.wrapHint': "[FIL] If the next line wraps, choose a smaller column value.",
    'print.test.success': "[FIL] If you can read this, your printer is working!",
    'receipt.billNumber': "[FIL] Bill #",
    'receipt.date': "[FIL] Date",
    'pos.tableLabel': "[FIL] Table: {name}",
    'pos.customer': "[FIL] Customer",
    'receipt.customerNo': "[FIL] Customer No",
    'receipt.phone': "[FIL] Ph",
    'receipt.item': "[FIL] Item",
    'receipt.qty': "[FIL] Qty",
    'receipt.rate': "[FIL] Rate",
    'receipt.amount': "[FIL] Amount",
    'printTest.amt': "[FIL] Amt",
    'pos.subtotal': "[FIL] Subtotal",
    'pos.discount': "[FIL] Discount",
    'pos.tax': "[FIL] Tax",
    'pos.delivery': "[FIL] Delivery",
    'receipt.totalTax': "[FIL] Total Tax",
    'receipt.serviceCharge': "[FIL] Service Charge",
    'receipt.taxDetails': "[FIL] Tax Details",
    'receipt.payments': "[FIL] Payments",
    'receipt.thankYou': "[FIL] Thank you for your visit!",
    'receipt.taxIncluded': "[FIL] Tax included where applicable",
    'receipt.reprint': "[FIL] REPRINT",
    'pos.methodCash': "[FIL] Cash",
    'pos.methodCard': "[FIL] Card",
    'pos.methodWallet': "[FIL] Wallet",
  },
};
