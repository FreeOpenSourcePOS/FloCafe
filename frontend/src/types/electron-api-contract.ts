...
export type ElectronApiContractChecks = [
  ...
  Expect<Equal<ElectronAPI['setSetting'], (key: string, value: string) => Promise<ElectronActionResult>>>,
  Expect<Equal<ElectronAPI['getKdsInfo'], () => Promise<KdsInfo>>>,
  Expect<Equal<ElectronAPI['openKdsWindow'], () => Promise<void>>>,
  Expect<Equal<ElectronAPI['getPrinters'], () => Promise<ElectronPrinter[] | ElectronIpcError>>>,
  Expect<Equal<ElectronAPI['savePrinter'], (printer: ElectronPrinterInput) => Promise<ElectronActionResult>>>,
